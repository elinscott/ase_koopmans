...
# Dynamic NEB with scaled convergence criteria
neb = NEB(images, fmax=fmax, dynamic_relaxation=True, scale_fmax=6.)
neb.interpolate()

# Optimize and check number of calculations with dyNEB.
...
# Check force calculation count for default and dyNEB implementations
