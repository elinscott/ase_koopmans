...
check('orcf', bravais['orcf'](4., 5., 3.).tocell())
check('orci', bravais['orci'](5., 6., 2.).tocell())
check('orcc', bravais['orcc'](4., 3., 5.).tocell())
check('hex', bravais['hex'](5., 6.).tocell())
check('rhl', bravais['rhl'](4., 54.).tocell())
check('mcl', bravais['mcl'](2., 3., 4., 62.).tocell())
check('mclc', bravais['mclc'](3., 5., 4., 70.).tocell())
check('tri', bravais['tri'](7., 6., 5., 34., 55., 80.).tocell())
