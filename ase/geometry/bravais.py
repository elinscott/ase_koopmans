...
def recognize_canonical_cell(cell, eps=2e-4):
...
def get_bravais_lattice_from_reduced_form(cell, eps=2e-4):
    # XXX We are just calling another function now
    return recognize_canonical_cell(cell, eps=eps)
