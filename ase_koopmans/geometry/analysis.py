# flake8: noqa
"""Tools for analyzing instances of :class:`~ase_koopmans.Atoms`
"""

from ase_koopmans.neighborlist import build_neighbor_list, get_distance_matrix, get_distance_indices
...
class Analysis(object):
    ...
    images: :class:`~ase_koopmans.Atoms` object or list of such
        Images to analyze.
    nl: None, :class:`~ase_koopmans.neighborlist.NeighborList` object or list of such
    ...
    kwargs: options, dict
        Arguments for constructing :class:`~ase_koopmans.neighborlist.NeighborList` object if :data:`nl` is None.

    The choice of ``bothways=True`` for the :class:`~ase_koopmans.neighborlist.NeighborList` object
    ...
    def _get_slice(self, imageIdx):
        ...
        if isinstance(imageIdx, int):
            ...
            raise ValueError("Unsupported type for imageIdx in ase_koopmans.geometry.analysis.Analysis._get_slice")
        return sl
    ...
    def distance_matrix(self):
        ...
        :meth:`ase_koopmans.neighborlist.get_distance_matrix`.
    ...
    def get_bond_value(self, imIdx, idxs, mic=True, **kwargs):
        ...
        mic: bool
            Passed on to :func:`ase_koopmans.Atoms.get_distance` for retrieving the value, defaults to True.
            If the cell of the image is correctly set, there should be no reason to change this.
        kwargs: options or dict
            Passed on to :func:`ase_koopmans.Atoms.get_distance`.
    ...
    def get_angle_value(self, imIdx, idxs, mic=True, **kwargs):
        ...
        mic: bool
            Passed on to :func:`ase_koopmans.Atoms.get_angle` for retrieving the value, defaults to True.
            If the cell of the image is correctly set, there should be no reason to change this.
        kwargs: options or dict
            Passed on to :func:`ase_koopmans.Atoms.get_angle`.
    ...
    def get_dihedral_value(self, imIdx, idxs, mic=True, **kwargs):
        ...
        mic: bool
            Passed on to :func:`ase_koopmans.Atoms.get_dihedral` for retrieving the value, defaults to True.
            If the cell of the image is correctly set, there should be no reason to change this.
        kwargs: options or dict
            Passed on to :func:`ase_koopmans.Atoms.get_dihedral`.
    ...
    def get_values(self, inputList, imageIdx=None, mic=True, **kwargs):
        ...
        inputList: list of lists of tuples
            Can be any list provided by :meth:`~ase_koopmans.geometry.analysis.Analysis.get_bonds`,
            :meth:`~ase_koopmans.geometry.analysis.Analysis.get_angles` or
            :meth:`~ase_koopmans.geometry.analysis.Analysis.get_dihedrals`.
        imageIdx: integer or slice
            The images from :data:`images` to be analyzed. If None, all frames will be analyzed.
            See :func:`~ase_koopmans.geometry.analysis.Analysis._get_slice` for details.
        mic: bool
            Passed on to :class:`~ase_koopmans.Atoms` for retrieving the values, defaults to True.
            If the cells of the images are correctly set, there should be no reason to change this.
        kwargs: options or dict
            Passed on to the :class:`~ase_koopmans.Atoms` classes functions for retrieving the values.
        ...
        The methods from the :class:`~ase_koopmans.Atoms` class are used.
        """
        ...
        if len(inputList[0][0]) == 2:
            ...
            raise ValueError("inputList in ase_koopmans.geometry.analysis.Analysis.get_values has a bad shape.")
    ...
    def get_rdf(self, rmax, nbins, imageIdx=None, elements=None, return_dists=False):
        ...
        Wrapper for :meth:`ase_koopmans.ga.utilities.get_rdf` with more selection possibilities.
        ...
        for image in self.images[sl]:
            ...
            #lists
                ...
                #list of strings
                    ...
                    raise ValueError("Unsupported type of elements given in ase_koopmans.geometry.analysis.Analysis.get_rdf!")
            else:
                raise ValueError("Unsupported type of elements given in ase_koopmans.geometry.analysis.Analysis.get_rdf!")
