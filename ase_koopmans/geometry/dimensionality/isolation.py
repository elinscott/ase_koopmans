...
from ase_koopmans.geometry.dimensionality import analyze_dimensionality
from ase_koopmans.geometry.dimensionality import rank_determination
from ase_koopmans.geometry.dimensionality.bond_generator import next_bond
...
def isolate_components(atoms, kcutoff=None):
    ...
    kcutoff: float
        The k-value cutoff to use.  Default=None, in which case_koopmans the
