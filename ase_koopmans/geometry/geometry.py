...
def wrap_positions(positions, cell, pbc=True, center=(0.5, 0.5, 0.5),
    ...
    :meth:`ase_koopmans.Atoms.wrap` method.
...
def get_angles(v1, v2, cell=None, pbc=None):
    ...
    # We just normalized the vectors, but in some case_koopmanss we can get
...
def get_distances(p1, p2=None, cell=None, pbc=None):
    ...
    are desired. p2 will be set to p1 in this case_koopmans.
