...
def cellpar_to_cell(cellpar, ab_normal=(0, 0, 1), a_direction=None):
    ...
    `ab_normal`, in which case_koopmans default `a_direction` is (0,0,1).
...
def crystal_structure_from_cell(cell, eps=2e-4, niggli_reduce=True):
    ...
    way as ase_koopmans.dft.kpoints.get_special_points().
...
from ase_koopmans.cell import Cell  # noqa
