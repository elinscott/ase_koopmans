...
class CLICommand:
    ...
    Example:
        ...
        $ ase_koopmans band-structure al.gpw -r -10 10
    """
    ...
    if bzkpts is None:
        ...
        try:
            ...
            if args.path is None:
                err = 'Please_koopmans specify a path!'
                try:
                    ...
                    from ase_koopmans.dft.kpoints import special_paths
...
def read_band_structure(args, parser):
    ...
    objtype = getattr(bs, 'ase_koopmans_objtype', None)
