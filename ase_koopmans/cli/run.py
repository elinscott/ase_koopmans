...
from ase_koopmans.constraints import FixAtoms, UnitCellFilter
from ase_koopmans.eos import EquationOfState
from ase_koopmans.io import read, write, Trajectory
from ase_koopmans.optimize import LBFGS
import ase_koopmans.db as db
...
class CLICommand:
    ...
    * equation-of-state
    ...
    Examples of the four types of calculations:
        ...
        ase_koopmans run emt h2o.xyz
        ase_koopmans run emt h2o.xyz -f 0.01
        ase_koopmans run emt cu.traj -s 0.01
        ase_koopmans run emt cu.traj -E 5,2.0
    """
...
class Runner:
    ...
    def eos(self, atoms, name):
        ...
        from ase_koopmans.parallel import parprint as p
        p('volumes:', volumes)
        p('energies:', energies)
        p('fitted energy:', e0)
        p('fitted volume:', v0)
