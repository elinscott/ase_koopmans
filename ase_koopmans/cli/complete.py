#!/usr/bin/env python3
"""Bash completion for ase_koopmans.

Put this in your .bashrc::

    complete -o default -C /path/to/ase_koopmans/cli/complete.py ase_koopmans

or run::

    $ ase_koopmans completion
...
def complete(word, previous, line, point):
    ...
    if command == 'db':
        ...
        if previous == 'run':
            from ase_koopmans.calculators.calculator import names as words
        ...
        if previous in ['-c', '--calculators']:
            ...
            from ase_koopmans.test.testsuite import all_test_modules_and_groups
...
if sys.version_info[0] == 2:
    ...
    warnings.warn('Command-line completion running with python2.  '
                  ...
                  'Please_koopmans consider rerunning \'ase_koopmans completion\'.')
