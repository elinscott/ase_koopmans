...
from ase_koopmans.io.formats import filetype, UnknownFileTypeError
from ase_koopmans.db import connect
from ase_koopmans.db.core import parse_selection
...
class CLICommand:
    ...
    See https://wiki.fysik.dtu.dk/ase_koopmans/ase_koopmans/db/db.html#querying for more
...
class FakeDB(JSONDatabase_koopmans):
