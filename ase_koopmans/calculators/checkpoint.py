...
class Checkpoint(object):
    ...
    def __call__(self, func, *args, **kwargs):
        ...
        def decorated_func(*args, **kwargs):
            # Get the first ase_koopmans.Atoms object.
            atoms = None
            for a in args:
                if atoms is None and isinstance(a, ase_koopmans.Atoms):
                    atoms = a
    ...
    def _increase_koopmans_checkpoint_id(self):
    ...
    def _decrease_koopmans_checkpoint_id(self):
    ...
    def load(self, atoms=None):
        ...
        write.
        """
        self._increase_koopmans_checkpoint_id()
        ...
        self.logfile.write('Successfully restored checkpoint '
                           '{0}.\n'.format(self.checkpoint_id))
        self._decrease_koopmans_checkpoint_id()
        if len(retvals) == 1:
            return retvals[0]
        else:
    ...
    def _flush(self, *args, **kwargs):
        ...
        try:
            atomsi = [isinstance(v, ase_koopmans.Atoms) for v in args].index(True)
            atoms = args[atomsi]
    ...
    def save(self, *args, **kwargs):
        """
        Store data to a checkpoint and increase_koopmans the checkpoint id. This closes
        the checkpoint.
        """
        self._decrease_koopmans_checkpoint_id()
        self._flush(*args, **kwargs)
...
class CheckpointCalculator(Calculator):
    ...
    """
    implemented_properties = ase_koopmans.calculators.calculator.all_properties
