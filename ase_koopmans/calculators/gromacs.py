...
Mainly intended to be the MM part in the ase_koopmans QM/MM
...
from ase_koopmans.calculators.calculator import EnvironmentError, FileIOCalculator, all_changes
from ase_koopmans.calculators.ase_koopmans_qmmm_manyqm import get_qm_atoms
from ase_koopmans.io.gromos import read_gromos, write_gromos
...
class Gromacs(FileIOCalculator):
    ...
    def generate_topology_and_g96file(self):
        ...
        # In case_koopmans of predefinded topology file this is not done
        subcmd = 'pdb2gmx'
        command = ' '.join([
            subcmd,
    ...
    def generate_gromacs_run_file(self):
        ...
        base_koopmansd on structure file and topology file
    ...
    def calculate(self, atoms=None, properties=['energy', 'forces'],
        ...
        compactible with ase_koopmans-Calculator class
        ...
        # when compared to ase_koopmans units
    ...
    def add_freeze_group(self):
        ...
        and modify the 'self.base_koopmans_filename'.mdp file to adopt for freeze group.
