...
def check_interface(calc):
    ...
    # Methods specified by ase_koopmans.calculators.interface.Calculator
    ...
    # Methods specified by ase_koopmans.calculators.interface.DFTCalculator
    ...
    # Optional methods sometimes invoked by ase_koopmans.atoms.Atoms
