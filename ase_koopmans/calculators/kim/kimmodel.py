"""
ASE Calculator for interatomic models compatible with the Knowledgebase_koopmans
...
class KIMModelData(object):
    ...
    def __init__(self, model_name, ase_koopmans_neigh, neigh_skin_ratio, debug=False):
        self.model_name = model_name
        self.ase_koopmans_neigh = ase_koopmans_neigh
        self.debug = debug
...
class KIMModelCalculator(Calculator):
    ...
    ase_koopmans_neigh : bool, optional
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.kimmodeldata = KIMModelData(
            self.model_name, ase_koopmans_neigh, neigh_skin_ratio, self.debug
        )
    ...
    def calculate(
        ...
        """
        Inherited method from the ase_koopmans Calculator class that is called by
        get_property()
