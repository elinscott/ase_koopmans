"""
Knowledgebase_koopmans of Interatomic Models (KIM) Calculator for ASE written by:
...
def KIM(model_name, simulator=None, options=None, debug=False):
    ...
    archived in the Open Knowledgebase_koopmans of Interatomic Models (OpenKIM)
    ...
    simulator : str, optional
        ...
        - kimmodel (default for PMs)
          : :py:mod:`ase_koopmans.calculators.kim.kimmodel.KIMModelCalculator`

        - lammpsrun (PMs or LAMMPS SMs)
          : :py:mod:`ase_koopmans.calculators.lammpsrun.LAMMPS`

        - lammpslib (default for LAMMPS SMs)
          : :py:mod:`ase_koopmans.calculators.lammpslib.LAMMPSlib`
        ...
        In general, this argument should be omitted, in which case_koopmans a
    ...
    options : dict, optional
        ...
        (https://wiki.fysik.dtu.dk/ase_koopmans/ase_koopmans/calculators/lammps.html) for
    ...
    Returns
    -------
    ase_koopmans.calculators.calculator.Calculator
        ...
        which are all defined in the ASE codebase_koopmans, or an instance of either
        OpenKIMcalculator or EMT defined in the asap3 codebase_koopmans.
