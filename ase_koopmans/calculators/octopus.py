...
import os
import numpy as np
from ase_koopmans.io.octopus.input import (
    process_special_kwargs, kwargs2atoms,
    generate_input, parse_input_file,
    normalize_keywords)
from ase_koopmans.io.octopus.output import read_eigenvalues_file, read_static_info
...
class Octopus(FileIOCalculator, EigenvalOccupationMixin):
    ...
    def __init__(self,
        ...
        if label is not None:
            ...
            #import warnings
            #warnings.warn('Please_koopmans use directory=... instead of label')
