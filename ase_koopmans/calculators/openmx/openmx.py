"""
    ...
    material simulations base_koopmansd on density functional theories.
...
class OpenMX(FileIOCalculator):
    ...
    def calculate(self, atoms=None, properties=None,
        ...
        if self.parameters.data_path is None:
            if not 'OPENMX_DFT_DATA_PATH' in os.environ:
                warnings.warn('Please_koopmans either set OPENMX_DFT_DATA_PATH as an'
    ...
    def get_command(self, processes, threads, runfile=None, outfile=None):
        ...
        except TypeError:  # in case_koopmans the OPENMX_COMMAND is incompatible
            raise ValueError(
    ...
    def get_band_structure(self, atoms=None, calc=None):
        ...
        ase_koopmans dft module """
        from ase_koopmans.dft import band_structure
