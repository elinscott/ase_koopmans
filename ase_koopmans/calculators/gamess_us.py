...
from ase_koopmans.io.gamess_us import clean_userscr, get_userscr
...
class GAMESSUS(FileIOCalculator):
    ...
    def __init__(self, restart=None, ignore_bad_restart_file=False,
        ...
        will be guessed base_koopmansd on the Atoms object's initial magnetic moments.
    ...
    def calculate(self, *args, **kwargs):
        ...
        if self.userscr is None:
            warnings.warn("Could not determine USERSCR! "
                          ...
                          "this job. Please_koopmans pass userscr to the GAMESSUS "
