...
>>> from ase_koopmans.calculators import DMol3
...
to the ase_koopmans coordinate system is found and applied to the forces.
...
DMol_atoms * rot_mat = ase_koopmans_atoms
...
from ase_koopmans.io.dmol import write_dmol_car, write_dmol_incoor
...
class DMol3(FileIOCalculator):
    ...
    def write_input(self, atoms, properties=None, system_changes=None):
        ...
        self.internal_transformation = False
        self.ase_koopmans_positions = atoms.positions.copy()
        self.ase_koopmans_cell = atoms.cell.copy()
        ...
        self.parameters.write(self.label + '.parameters.ase_koopmans')
    ...
    def read(self, label):
        ...
        self.parameters = Parameters.read(self.label + 'parameters.ase_koopmans')
        self.read_results()
    ...
    def find_dmol_transformation(self, tol=1e-4):
        ...
        coordinates to ase_koopmans coordinates.
        ...
        positions are parsed and compared to self.ase_koopmans_cell self.ase_koopmans_positions.
    ...
    def clean(self):
        ...
        file_extensions = ['basis', 'car', 'err', 'grad', 'input', 'inatm',
                           ...
                           'torder', 'out', 'parameters.ase_koopmans']
