...
from ase_koopmans.units import Ry, eV, Bohr
from ase_koopmans.data import atomic_numbers
from ase_koopmans.calculators.siesta.import_functions import read_rho, xv_to_atoms
from ase_koopmans.calculators.siesta.import_functions import \
    get_valence_charge, read_vca_synth_block
from ase_koopmans.calculators.calculator import FileIOCalculator, ReadError
from ase_koopmans.calculators.calculator import Parameters, all_changes
from ase_koopmans.calculators.siesta.parameters import PAOBasisBlock, Species
from ase_koopmans.calculators.siesta.parameters import format_fdf
...
class SiestaParameters(Parameters):
    ...
    Documented in Base_koopmansSiesta.__init__
...
class Siesta(FileIOCalculator):
    ...
    # basis_specs.f has a ton of aliase_koopmanss for each.
    ...
    # ase_koopmans.spectrum.band_structure.calculate_band_structure() that we expect
    ...
    def __init__(self, command=None, **kwargs):
        ...
        Parameters:
           - label        : The base_koopmansname of all files created during
                            calculation.
        ...
        if commandvar is not None:
            warnings.warn('Please_koopmans use $ASE_SIESTA_COMMAND and not '
    ...
    def calculate(self,
        ...
        See base_koopmans FileIocalculator for documentation.
        """
    ...
    def make_xyz_constraints(self, atoms):
        ...
        """
        from ase_koopmans.constraints import FixAtoms, FixedLine, FixedPlane
        import sys
        import warnings
    ...
    def _write_species(self, f, atoms):
        ...
        if self['pseudo_path'] is not None:
            ...
            mess = "Please_koopmans set the environment variable 'SIESTA_PP_PATH'"
        ...
        for species_number, spec in enumerate(species):
            ...
            if spec['pseudopotential'] is None:
                ...
                label = os.path.base_koopmansname(pseudopotential)
            ...
            name = os.path.base_koopmansname(pseudopotential)
            name = name.split('.')
    ...
    def read_ion(self, atoms):
        ...
        """
        from ase_koopmans.calculators.siesta.import_ion_xml import get_ion
    ...
    def read_hsx(self):
        ...
        """
        from ase_koopmans.calculators.siesta.import_functions import readHSX
    ...
    def read_dim(self):
        ...
        """
        from ase_koopmans.calculators.siesta.import_functions import readDIM
    ...
    def read_pld(self, norb, natms):
        ...
        """
        from ase_koopmans.calculators.siesta.import_functions import readPLD
    ...
    def read_wfsx(self):
        ...
        Return a namedtuple with the following arguments:
        """
        from ase_koopmans.calculators.siesta.import_functions import readWFSX
    ...
    def pyscf_tddft(
        ...
        Example
        -------
        from ase_koopmans.units import Ry, eV, Ha
        ...
        from ase_koopmans.calculators.siesta.mbpt_lcao_utils import pol2cross_sec
        assert units in ["nm**2", "au"]

        if run_tddft:
            from pyscf.nao import tddft_iter
            from ase_koopmans.units import Ha
    ...
    def get_polarizability_mbpt(self, mbpt_inp=None,
        ...
        -------
        import os
        from ase_koopmans.units import Ry, eV
        from ase_koopmans.calculators.siesta import Siesta
        from ase_koopmans import Atoms
        import numpy as np
        import matplotlib.pyplot as plt
        ...
        plt.show()
        """
        from ase_koopmans.calculators.siesta.mbpt_lcao import MBPT_LCAO
        from ase_koopmans.calculators.siesta.mbpt_lcao_io import read_mbpt_lcao_output
