...
from ase_koopmans.calculators.calculator import Calculator, kpts2ndarray
from ase_koopmans.units import Bohr, Ha
    ...
    def init(self):
        ...
        for i in range(2):
            ...
            for j in range(2):
                ...
                phase_koopmans = np.exp(pi * 2j * np.dot(self.ibzk, (i, j, 0)))
                self.psi += phase_koopmans[:, None, None, None] * phi
