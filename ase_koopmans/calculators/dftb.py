...
import os
import numpy as np
from ase_koopmans.calculators.calculator import (FileIOCalculator, kpts2ndarray,
                                        kpts2sizeandoffsets)
...
class Dftb(FileIOCalculator):
    ...
    def __init__(self, restart=None, ignore_bad_restart_file=False,
        ...
        kpts: (default None)
            ...
            * ``dict``: Interpreted as a path in the Brillouin zone if
              ...
              ``ase_koopmans.calculators.calculator.kpts2sizeandoffsets``
    ...
    def read_charges_and_energy(self):
        """Get partial charges on atoms
            in case_koopmans we cannot find charges they are set to None
        """
