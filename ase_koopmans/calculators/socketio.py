...
class SocketClient:
    def __init__(self, host='localhost', port=None,
        ...
        comm: communicator or None
            MPI communicator object.  Defaults to ase_koopmans.parallel.world.
        ...
        try:
            while True:
                ...
                if msg == 'EXIT':
                    ...
                    #
                    # (In that case_koopmans we should MPI-synchronize *before*
...
class SocketIOCalculator(Calculator):
    ...
    def __init__(self, calc=None, port=None,
        ...
        timeout: float >= 0 or None
            ...
            recommended to set a timeout in case_koopmans of undetected
            client-side failure.
    ...
    def calculate(self, atoms=None, properties=['energy'],
        ...
        if self.calculator_initialized and any(bad):
            raise PropertyNotImplementedError(
                ...
                'Please_koopmans create new socket calculator.'
        ...
        if self.atoms.number_of_lattice_vectors == 3 and any(self.atoms.pbc):
            from ase_koopmans.constraints import full_3x3_to_voigt_6_stress
