...
class FLEUR:
    ...
    executable for real and complex case_koopmanss (systems with/without inversion
    ...
    def run_executable(self, mode='fleur', executable='FLEUR'):
        ...
        try:
            ...
            raise RuntimeError('Please_koopmans set ' + executable_use)
    ...
    def write_inp(self, atoms):
        ...
        try:
            ...
            raise RuntimeError('Please_koopmans set FLEUR_INPGEN')
        ...
        for ln, line in enumerate(lines):
            ...
            if self.itmax < self.itmax_step_default and line.startswith('itmax'):
                # decrease_koopmans number of SCF steps; increasing is done by 'while not self.converged:'
                lsplit = line.split(',')
