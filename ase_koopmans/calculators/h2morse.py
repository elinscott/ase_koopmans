...
from ase_koopmans.units import invcm, Ha
...
from ase_koopmans.calculators.excitation_list import Excitation, ExcitationList
...
class H2MorseCalculator(MorsePotential):
    ...
    def calculate(self, atoms=None, properties=['energy'],
        ...
        # Berry phase_koopmans (arbitrary sign) and
