...
from ase_koopmans.calculators.calculator import FileIOCalculator, ReadError, Parameters
from ase_koopmans.units import kcal, mol, Debye
...
class MOPAC(FileIOCalculator):
    ...
    def __init__(self, restart=None, ignore_bad_restart_file=False,
        ...
        >>> from ase_koopmans.calculators.mopac import MOPAC
        >>> atoms = molecule('O2')
