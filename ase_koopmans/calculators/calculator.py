...
from ase_koopmans.outputs import Properties, all_outputs
from ase_koopmans.utils import jsonable


class CalculatorError(RuntimeError):
    """Base_koopmans class of error types related to ASE calculators."""
...
def register_calculator_class(name, cls):
    """ Add the class into the database_koopmans. """
...
def get_calculator_class(name):
    ...
    if name == 'asap':
        ...
        from ase_koopmans.calculators.vasp import Vasp2 as Calculator
    elif name == 'ace':
        from ase_koopmans.calculators.acemolecule import ACE as Calculator
    elif name == 'Psi4':
        from ase_koopmans.calculators.psi4 import Psi4 as Calculator
    elif name in external_calculators:
        Calculator = external_calculators[name]
    else:
        classname = special.get(name, name.title())
        module = __import__('ase_koopmans.calculators.' + name, {}, None, [classname])
...
class Calculator(object):
    """Base_koopmans-class for all ASE calculators.
    ...
    def __init__(self, restart=None, ignore_bad_restart_file=False, label=None,
        ...
        label: str
            ...
            May contain a directory, but please_koopmans use the directory parameter
            for that instead.
        atoms: Atoms object
    ...
    def todict(self, skip_default=True):
        ...
        for key, value in self.parameters.items():
            if hasattr(value, 'ase_koopmans_objtype'):
                from ase_koopmans.io.jsonio import MyEncoder
    ...
    def read(self, label):
        ...
        raised.  In case_koopmans of succes, these attributes must set:
    ...
    def calculate_numerical_forces(self, atoms, d=0.001):
        ...
        from ase_koopmans.calculators.test import numeric_force
    ...
    def band_structure(self):
        ...
        from ase_koopmans.spectrum.band_structure import get_band_structure
...
class FileIOCalculator(Calculator):
    """Base_koopmans class for calculators that write/read input/output files."""
    ...
    def calculate(self, atoms=None, properties=['energy'],
        ...
        if self.command is None:
            raise CalculatorSetupError(
                'Please_koopmans set ${} environment variable '
