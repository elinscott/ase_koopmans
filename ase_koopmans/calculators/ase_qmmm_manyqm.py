...
I'm especially interested in case_koopmanss when we need two or more
...
def get_neighbor_list(system):
    """
    Makes a neighbor list of a system (ase_koopmans Atoms).
    See
    https:\
    //wiki.fysik.dtu.dk/ase_koopmans/ase_koopmans/calculators/calculators.html#module-calculators
    """
    ...
    NEIGHBOR_FILE = 'neighbor_list_for_ase_koopmans_qmmm.txt'

    if os.path.exists(NEIGHBOR_FILE):
        print('Reading qm/mm neighbor list from file:')
        print('neighbor_list_for_ase_koopmans_qmmm.txt')
...
class LinkAtom:
    ...
    def set_link_atom(self, atom):
        """ set an ase_koopmans-atom to be the link atom """
        self.atom = atom
    ...
    def get_link_atom(self):
        """ get an ase_koopmans-atom to be the link atom """
        return self.atom
...
class AseQmmmManyqm:
    ...
    def __init__(self,  nqm_regions,  \
        ...
        qm_calculators: list members of a Class defining a Calculator
            ase_koopmans-qm calculator for each qm region

        mm_calculator: a member of a Class defining a Calculator
             ase_koopmans-mm calculator for mm (the whole system)
    ...
    def run(self, atoms):
        ...
        #generate gromacs run file (.tpr) base_koopmans on new topology
        self.mm_calculator.generate_gromacs_run_file()
        self.calculate_mm()
    ...
    def get_link_atoms(self, qm_links, mm_links, \
        ...
        """
        QM atoms can be bonded to MM atoms. In this case_koopmans one sets
    ...
    def set_qm_charges_to_mm_topology(self):
        """ Set qm charges to qm atoms of MM topology base_koopmansd on
        a QM calculation.
...
#------------------------------------------------------------------
    ...
    def define_QM_clusters_in_vacuum(self, system):
        ...
        (in case_koopmans we have many QM regions).
        """
