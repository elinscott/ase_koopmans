...
from ase_koopmans.calculators.calculator import FileIOCalculator, PropertyNotPresent


error_template = 'Property "%s" not available. Please_koopmans try running Quantum\n' \
...
warn_template = 'Property "%s" is None. Typically, this is because the ' \
                ...
                'Please_koopmans try running Quantum Espresso with "high" verbosity.'
