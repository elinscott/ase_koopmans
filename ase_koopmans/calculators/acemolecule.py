...
from ase_koopmans.io.acemolecule import read_acemolecule_out
from ase_koopmans.calculators.calculator import ReadError
...
#    results = {}
    ...
    def prepare_input(self, geometry_filename, properties):
        '''Initialize parameters dictionary base_koopmansd on geometry filename and calculated properties.
