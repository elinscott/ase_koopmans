...
from ase_koopmans.calculators.calculator import SCFError
...
class QChem(FileIOCalculator):
    ...
    def __init__(self, restart=None, ignore_bad_restart_file=False,
        ...
        The calculator will convert these options to upper case_koopmans
        ...
        with open(filename, 'r') as fileobj:
            ...
            for line in lineiter:
                if 'SCF failed to converge' in line:
                    ...
                    convert = ase_koopmans.units.Hartree
                    ...
                    while True:
                        ...
                        if ' Max gradient component' in next(lineiter):
                            ...
                            self.results['forces'] = np.array(gradient).T * (
                                -ase_koopmans.units.Hartree / ase_koopmans.units.Bohr)
                            break
