...
from ase_koopmans.units import Bohr, Hartree
...
from ase_koopmans.calculators.calculator import equal
...
class Parameters_deMon(Parameters):
    ...
    Documented in Base_koopmans_deMon.__init__
...
class Demon(FileIOCalculator):
    ...
    def __init__(self, **kwargs):
        ...
        export DEMON_COMMAND="deMon.4.3.6.std > deMon_ase_koopmans.out 2>&1"
        ...
        For example usage, see the tests h2o.py and h2o_xas_xes.py in the directory ase_koopmans/test/demon
    ...
    def calculate(self,
        ...
        if self.command is None:
            raise RuntimeError('Please_koopmans set $%s environment variable ' %
                               ('DEMON_COMMAND') +
        ...
        if basis_path is None:
            raise RuntimeError('Please_koopmans set basis_path keyword,' +
    ...
    def set_label(self, label):
        ...
        # in our case_koopmans self.directory = self.label
    ...
    def write_input(self, atoms, properties=None, system_changes=None):
        ...
        with open(filename, 'w') as f:
            ...
            ase_koopmans.io.write(self.label + '/deMon_atoms.xyz', self.atoms)
    ...
    def deMon_inp_to_atoms(self, filename):
        ...
        for i in range(ii + 1, len(lines)):
            try:
                ...
                if(len(line) > 0):
                    for symbol in ase_koopmans.data.chemical_symbols:
                        found = None
        ...
        # set atoms object
        atoms = ase_koopmans.Atoms(symbols=chemical_symbols, positions=xyz)
