...
class CP2K(Calculator):
    ...
    def write(self, label):
        ...
        self.parameters.write(label + '_params.ase_koopmans')
        from ase_koopmans.io.jsonio import write_json
    ...
    def read(self, label):
        ...
        self.atoms = ase_koopmans.io.read(label + '_restart.traj')
        self.parameters = Parameters.read(label + '_params.ase_koopmans')
    ...
    def __init__(self, command, debug):
        ...
        if not line.startswith('CP2K Shell Version:'):
            raise RuntimeError('Cannot determine version of CP2K shell.  '
                               ...
                               'Please_koopmans update to CP2K 3.0 or newer.')
