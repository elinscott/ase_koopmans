def test_parsemath():
    ...
    try:
        ...
        raise RuntimeError("This should not be reached, the parser is now vulnerable to computational time base_koopmansd DNS attack")
    except ValueError:
        pass

    try:
        eval_expression("e"*10000000, dict())
        raise RuntimeError("This should not be reached, the parser is now vulnerable to memory base_koopmansd DNS attack")
    except ValueError:
        pass
