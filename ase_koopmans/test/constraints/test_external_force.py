def test_external_force():
    """Tests for class ExternalForce in ase_koopmans/constraints.py"""
    from ase_koopmans import Atoms
    from ase_koopmans.constraints import ExternalForce, FixBondLength
    ...
    # Distance should increase_koopmans due to the external force
    assert dist2 > dist1
    ...
    # Fix another bond and incrase_koopmans the external force
    f_ext *= 2
    con1 = ExternalForce(atom1, atom2, f_ext)
