...
------------------------------------------------------------
          ...
          When using FHI-aims, please_koopmans cite the following reference:
          ...
          For any questions about FHI-aims, please_koopmans visit the aimsclub website
...
------------------------------------------------------------
  ...
  **Attention: initial geometry.in file will be ignored!
  ...
  Spin handling was not defined in control.in. Defaulting to unpolarized case_koopmans.
  ...
  Using density matrix base_koopmansd charge density update.
  Using density matrix base_koopmansd charge density update.
...
------------------------------------------------------------
  ...
  If you use a very high smearing, use empty_states (per atom!) in control.in to increase_koopmans this value.
...
* Please_koopmans make sure species are declared in the same order in           *
...
------------------------------------------------------------
  ...
  | Consuming        186 KiB for k_phase_koopmans.
  ...
  Integrating Hamiltonian matrix: batch-base_koopmansd integration.
...
------------------------------------------------------------
  ...
  | Consuming        228 KiB for k_phase_koopmans.
  | Number of super-cells (origin) [n_cells]                     :        2197
...
------------------------------------------------------------------------------
  ...
  Before relying on these values, please_koopmans be sure to understand exactly which
...
------------------------------------------------------------------------------
  ...
  If you publish the results, please_koopmans make sure to cite these reference if they apply.
  ...
  For any use of FHI-aims, please_koopmans cite:
  ...
  For the analytical stress tensor used in your run, please_koopmans cite:
  ...
  Please_koopmans check out http://elsi-interchange.org to learn more.
  If scalability is important for your project, please_koopmans acknowledge ELSI by citing:
  ...
  For the real-space grid partitioning and parallelization used in this calculation, please_koopmans cite:
  ...
  FHI-aims code. The reason is purely practical (length of this list) - please_koopmans credit others as well.
