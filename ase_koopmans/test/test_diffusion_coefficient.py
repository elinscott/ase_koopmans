def test_diffusion_coefficient():
    from ase_koopmans.md.analysis import DiffusionCoefficient
    from ase_koopmans.atoms import Atoms
    from ase_koopmans.units import fs as fs_conversion

    eps = 1e-10
    # Creating simple trajectories
    # Textbook case_koopmans. The displacement coefficient should be 0.5 A^2 / fs except for the final molecule
