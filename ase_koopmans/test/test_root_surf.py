def test_root_surf():
    ...
    from ase_koopmans.build import bcc111
    from ase_koopmans.build import hcp0001
    from ase_koopmans.build import fcc111_root
    from ase_koopmans.build import root_surface
    from ase_koopmans.build import root_surface_analysis
