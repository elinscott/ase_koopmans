def test_vasp_input():
    ...
    from ase_koopmans.calculators.vasp.create_input import _args_without_comment
    from ase_koopmans.calculators.vasp.create_input import _to_vasp_bool, _from_vasp_bool
