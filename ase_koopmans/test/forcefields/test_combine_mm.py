def test_combine_mm():
    ...
    from ase_koopmans.calculators.counterions import AtomicCounterIon as ACI
    from ase_koopmans.calculators.combine_mm import CombineMM
    from ase_koopmans.calculators.qmmm import LJInteractionsGeneral
    from ase_koopmans.calculators.tip3p import TIP3P, rOH, angleHOH
    from ase_koopmans.calculators.tip4p import TIP4P
    from ase_koopmans.calculators.tip3p import epsilon0 as eps3
    from ase_koopmans.calculators.tip3p import sigma0 as sig3
    from ase_koopmans.calculators.tip4p import epsilon0 as eps4
    from ase_koopmans.calculators.tip4p import sigma0 as sig4
