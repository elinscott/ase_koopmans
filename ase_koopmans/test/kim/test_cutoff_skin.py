def test_cutoff_skin():
    ...
    to be zero in any case_koopmans.  Next, we reduce the dimer separation by less
    ...
    case_koopmans should be significantly far off from zero.  However, if the atom
