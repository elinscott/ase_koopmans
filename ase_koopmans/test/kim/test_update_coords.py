def test_update_coords():
    ...
    occurring at one point (see https://gitlab.com/ase_koopmans/ase_koopmans/merge_requests/1442)!
    """
    import numpy as np
    from ase_koopmans import Atoms
    from pytest import importorskip
    importorskip('kimpy')
    from ase_koopmans.calculators.kim import KIM
    ...
    for pbc in [False, True]:
        ...
        # NeighborList subclass instance (see ase_koopmans/calculators/kim/neighborlist.py) and,
