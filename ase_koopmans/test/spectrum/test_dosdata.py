...
from ase_koopmans.spectrum.dosdata import DOSData, GridDOSData, RawDOSData
...
class TestDosData:
    """Test the abstract base_koopmans class for DOS data"""
    sample_info = [(None, {}),
                   ({}, {}),
...
class TestRawDosData:
    ...
    sampling_data_args_results = [
        # Special case_koopmans: peak max at width 1
        ([[0.], [1.]],
         [[0.], {'width': 1}],
         [1. / (np.sqrt(2. * np.pi))]),
        ...
        # And a case_koopmans with multiple values, generated
