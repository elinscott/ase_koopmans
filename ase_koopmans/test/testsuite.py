...
from ase_koopmans.calculators.calculator import names as calc_names, get_calculator_class
from ase_koopmans.cli.info import print_info
    ...
    def run(args):
        ...
        if args.tests:
            ...
            for testname in testnames:
                add_args('ase_koopmans.test.{}'.format(testname))
        else:
            add_args('ase_koopmans.test')
        ...
        if not have_module('pytest'):
            raise CLIError('Cannot import pytest; please_koopmans install pytest '
                           'to run tests')
