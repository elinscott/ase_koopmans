def test_particle_operators(seed):
    ...
    from ase_koopmans.ga.particle_crossovers import CutSpliceCrossover
    ...
    from ase_koopmans.ga.particle_mutations import COM2surfPermutation
    # from ase_koopmans.ga.particle_mutations import RandomPermutation
    # from ase_koopmans.ga.particle_mutations import Poor2richPermutation
    # from ase_koopmans.ga.particle_mutations import Rich2poorPermutation
