def test_geometry():
    """Test the ase_koopmans.geometry module and ase_koopmans.build.cut() function."""


    import numpy as np

    from ase_koopmans.build import cut, bulk, fcc111
    from ase_koopmans.cell import Cell
    from ase_koopmans.geometry import get_layers, wrap_positions
    from ase_koopmans.spacegroup import crystal, get_spacegroup
