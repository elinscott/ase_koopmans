...
from ase_koopmans.spacegroup import (get_bravais_class,
                            get_point_group,
                            polar_space_group,
                            Spacegroup)
from ase_koopmans.spacegroup.spacegroup import SpacegroupNotFoundError
import ase_koopmans.lattice
...
@pytest.mark.parametrize("sg,lattice,point_group,polar",
                         [[100, ase_koopmans.lattice.TET, '4mm', True],
                          [225, ase_koopmans.lattice.FCC, '4/m -3 2/m', False]])
...
def test_spacegroup_reciprocal_cell():
    ...
    # how to not list hundreds of test case_koopmanss in the output.
    for setting in [1, 2]:
