...
from ase_koopmans import build


# This file is parsed correctly by pw.x, even though things are
# scattered all over the place with some namelist edge case_koopmanss
pw_input_text = """
&CONTrol
...
pw_output_text = """
     ...
     for quantum simulation of materials; please_koopmans cite
