...
This is a base_koopmans class for numerous classes setting up pieces of crystal.
"""
...
class Bravais:
    ...
    This is a base_koopmans class for the objects producing various lattices
    (SC, FCC, ...).
    """
    ...
    def process_element(self, element):
        ...
        if self.element_basis is None:
            if isinstance(element, str):
                self.atomicnumber = ase_koopmans.data.atomic_numbers[element]
            ...
            for e in element:
                if isinstance(e, str):
                    atomicnumber.append(ase_koopmans.data.atomic_numbers[e])
