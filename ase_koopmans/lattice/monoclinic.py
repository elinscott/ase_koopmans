...
The following lattice creator is defined:
    SimpleMonoclinic
    Base_koopmansCenteredMonoclinic
"""
...
class Base_koopmansCenteredMonoclinicFactory(SimpleMonoclinicFactory):
...
Base_koopmansCenteredMonoclinic = Base_koopmansCenteredMonoclinicFactory()
