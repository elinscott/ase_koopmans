...
def calculate_band_structure(atoms, path=None, scf_kwargs=None,
    ...
    from ase_koopmans.lattice import celldiff  # Should this be a method on cell?
    ...
    if cell_err > cell_tol:
        raise ValueError('Atoms and band path have different unit cells.  '
                         'Please_koopmans reduce atoms to standard form.  '
...
def get_band_structure(atoms=None, calc=None, path=None, reference=None):
    ...
    if path is None:
        from ase_koopmans.dft.kpoints import resolve_custom_points, find_bandpath_kinks
...
class BandStructure:
    ...
    @property
    def path(self) -> 'ase_koopmans.dft.kpoints.BandPath':
        """The :class:`~ase_koopmans.dft.kpoints.BandPath` of this band structure."""
        return self._path
