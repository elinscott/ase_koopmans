...
class DOSData(metaclass=ABCMeta):
    """Abstract base_koopmans class for a single series of DOS-like data
...
class GeneralDOSData(DOSData):
    """Base_koopmans class for a single series of DOS-like data

    Only the 'info' is a mutable attribute; DOS data is set at init

    This is the base_koopmans class for DOSData objects that accept/set seperate
...
class GridDOSData(GeneralDOSData):
    ...
    def plot_dos(self,
        ...
        set to zero, in which case_koopmans:
