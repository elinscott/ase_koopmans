...
from ase_koopmans.parallel import parprint, paropen
from ase_koopmans.vibrations import Vibrations
from ase_koopmans.vibrations.resonant_raman import ResonantRaman
from ase_koopmans.vibrations.franck_condon import FranckCondonOverlap
from ase_koopmans.vibrations.franck_condon import FranckCondonRecursive
...
class Albrecht(ResonantRaman):
    ...
    def set_approximation(self, value):
        ...
        if approx in ['albrecht', 'albrecht b', 'albrecht c', 'albrecht bc']:
            ...
            raise ValueError('Please_koopmans use "Albrecht" or "Albrecht A/B/C/BC"')
        self._approx = value
