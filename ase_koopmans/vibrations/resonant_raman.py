...
import ase_koopmans.units as u
from ase_koopmans.parallel import world, parprint, paropen
from ase_koopmans.vibrations import Vibrations
from ase_koopmans.utils.timing import Timer
from ase_koopmans.utils import convert_string_to_fd


class ResonantRaman(Vibrations):
    """Base_koopmans Class for resonant Raman intensities using finite differences.
    ...
    def __init__(self, atoms, Excitations,
        ...
        Parameters
        ----------
        atoms: ase_koopmans Atoms object
        Excitations: class
    ...
    def calculate(self, atoms, filename, fd):
        ...
        base_koopmansname, _ = os.path.splitext(filename)
        excitations = self.exobj(
            self.atoms.calc, **self.exkwargs)
        excitations.write(base_koopmansname + self.exext)
    ...
    def absolute_intensity(self, omega, gamma=0.1, delta=0):
        ...
        ---------
        omega: float
           incoming lase_koopmansr energy, unit eV
        gamma: float
