...
from ase_koopmans.geometry import find_mic, wrap_positions
from ase_koopmans.utils.parsemath import eval_expression
...
class FixConstraint:
    """Base_koopmans class for classes that fix one or more atoms in some way."""
...
class FixConstraintSingle(FixConstraint):
    """Base_koopmans class for classes that fix a single atom."""
...
class FixParametricRelations(FixConstraint):
    ...
    def __init__(
        ...
        These constraints are base_koopmansd off the work in: https://arxiv.org/abs/1908.01610
        ...
        Args:
            ...
            params (list of str): parameters used in the parametric representation
                if None a list is generated base_koopmansd on the shape of the Jacobian
    ...
    def from_expressions(cls, indices, params, expressions, eps=1e-12, use_cell=False):
        ...
        for expr_ind, expression in enumerate(expressions):
            ...
            # Sort by string length (long to short) to prevent case_koopmanss like x11 becoming f"{param_map["x1"]}1"
...
class Hookean(FixConstraint):
    ...
    def __init__(self, a1, a2, k, rt=None):
        ...
        rt : float
           ...
           This argument is not supplied in case_koopmans 3. Units of A.
...
class ExternalForce(FixConstraint):
    ...
    see ase_koopmans/test/external_force.py"""
...
class UnitCellFilter(Filter):
    ...
    def set_positions(self, new, **kwargs):
        ...
        # symmetrize the atom step, it does so base_koopmansd on consistent (same cell)
...
class ExpCellFilter(UnitCellFilter):
    ...
    def __init__(self, atoms, mask=None,
        ...
        The implementation is base_koopmansd on that of Christoph Ortner in JuLIP.jl:
