# flake8: noqa
"""
The following contains the S22 and s26 database_koopmanss of weakly interacting dimers and complexes
...
where a large and more complete basis set has been used for all database_koopmans members.
...
This defines the s22x5 database_koopmans containing one shortened and three elongated structures:
...
'2-pyridoxine_2-aminopyridine_complex': {
    'description': "Complex, S22, S26, 2 h-bond, double h-bond, nucleic base_koopmans model",
...
'Adenine-thymine_complex_stack': {
    'description': "Complex, S22, S26, stack, dispersion bonded, nucleic base_koopmans",
...
'Adenine-thymine_Watson-Crick_complex': {
    'description': "Complex, S22, S26, 2 h-bonds, double h-bond, nucleic base_koopmans",
...
def identify_s22_sys(name,dist=None):
    ...
    if s22_ is False and s22x5_ is False:
        raise KeyError('s22 combination %s %s not in database_koopmans' %(name,str(dist)))
...
def get_s22_number(name,dist=None):
    """Returns the S22/S26 database_koopmans number of a system as a string.
    """
...
def get_name(name,dist=None):
    """Returns the database_koopmans name of an s22 system
    """
    s22_,s22x5_,s22_name,dist_ = identify_s22_sys(name,dist)
    if s22x5_ is True:
