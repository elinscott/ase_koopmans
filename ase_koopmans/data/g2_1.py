...
def get_ionization_energy(name, vertical=True):
    """Return the experimental ionization energy from the database_koopmans.
...
def get_atomization_energy(name):
    """Determine extrapolated experimental atomization energy from the database_koopmans.
    ...
    >>> from ase_koopmans.units import *; print kcal / mol
    0.0433641146392
