...
class Symbols:
    ...
    ``atoms.symbols`` is a :class:`ase_koopmans.symbols.Symbols` object.  This
    ...
    The :class:`ase_koopmans.formula.Formula` object is useful for extended
    ...
    def get_chemical_formula(self, mode='hill', empirical=False):
        ...
        See documentation of ase_koopmans.atoms.Atoms.get_chemical_formula()."""
