...
Authors: Simone Sturniolo (ase_koopmans implementation), Tim Green (original magres
    parser code)
"""
...
def read_magres(fd, include_unrecognised=False):
    ...
    magres_units = {'Angstrom': ase_koopmans.units.Ang}
    ...
    if 'magres_units' in image.info:
        ...
        for u in image.info['magres_units']:
            ...
            if p in _mprops:
                ...
                if order == 0:
                    # The case_koopmans of susceptibility
                    tens = {
