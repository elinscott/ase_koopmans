...
def read_pw_out(fileobj, index=-1, results_required=True):
    ...
    # TODO: index -1 special case_koopmans?
    ...
    # is one that has results. Two case_koopmanss:
    ...
    for image_index in image_indexes:
        ...
        for stress_index in indexes[_PW_STRESS]:
            if image_index < stress_index < next_index:
                ...
                # sign convention is opposite of ase_koopmans
...
def parse_pwo_start(lines, index=0):
    ...
    - `atoms`: an `ase_koopmans.Atoms` object constructed from the extracted data
...
# Input file writing
###
# Ordered and case_koopmans insensitive
KEYS = Namelist((
    ('CONTROL', [
    ...
    ('ELECTRONS', [
        ...
        'diago_full_acc', 'efield', 'efield_cart', 'efield_phase_koopmans',
