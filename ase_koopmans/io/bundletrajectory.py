...
from ase_koopmans.parallel import paropen, world, barrier
from ase_koopmans.calculators.singlepoint import (SinglePointCalculator,
                                         PropertyNotImplementedError)
from ase_koopmans.io.ulm import open as ulmopen
import numpy as np
import os
import sys
import shutil
import time
# The system json module causes memory leaks!  Use ase_koopmans's own.
# import json

from ase_koopmans import Atoms
from ase_koopmans.io import jsonio
...
def main():
    ...
    parser = optparse.OptionParser(
        usage='python -m ase_koopmans.io.bundletrajectory '
        'a.bundle [b.bundle ...]',
