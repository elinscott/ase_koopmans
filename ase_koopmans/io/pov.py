...
from ase_koopmans.io.utils import PlottingVariables
    ...
    def __init__(self, atoms, scale=1.0, **parameters):
        ...
        self.material_styles_dict = dict(
            ...
            jmol=('finish {ambient 0.2 diffuse 0.6 specular 1 roughness 0.001 '
                  'metallic}'),
            ase_koopmans2=('finish {ambient 0.05 brilliance 3 diffuse 0.6 metallic '
                  'specular 0.7 roughness 0.04 reflection 0.15}'),
            ase_koopmans3=('finish {ambient 0.15 brilliance 2 diffuse 0.6 metallic '
...
def add_isosurface_to_pov(pov_fid, pov_obj,
                          ...
                          color=(0.85, 0.80, 0.25, 0.2), material='ase_koopmans3',
                          verbose=False):
