...
class TrajectoryWriter:
    ...
    def _open(self, filename, mode):
        import ase_koopmans.io.ulm as ulm
        if mode not in 'aw':
    ...
    def _write_atoms(self, atoms, **kwargs):
        ...
        if self.header_data is None:
            b.write(version=1, ase_koopmans_version=__version__)
            if self.description:
...
class TrajectoryReader:
    ...
    def _read_header(self):
        ...
        if len(b) > 0:
            ...
            self.ase_koopmans_version = b.get('ase_koopmans_version')
...
def main():
    import optparse
    parser = optparse.OptionParser(usage='python -m ase_koopmans.io.trajectory '
                                   'a1.traj [a2.traj ...]',
