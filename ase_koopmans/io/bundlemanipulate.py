...
python -m ase_koopmans.io.bundlemanipulate inbundle outbundle [start [end [step]]]
"""
...
from ase_koopmans.io.bundletrajectory import PickleBundleBackend, UlmBundleBackend
