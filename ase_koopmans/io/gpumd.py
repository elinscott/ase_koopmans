...
from ase_koopmans.data import atomic_masses, chemical_symbols
...
def load_xyz_input_gpumd(fd, species=None, isotope_masses=None):
    ...
    """
    Read the structure input file for GPUMD and return an ase_koopmans Atoms object
    ...
    isotope_masses: Dict[str, List[float]]
        ...
        closest match :data:`ase_koopmans.data.atomic_masses`.
