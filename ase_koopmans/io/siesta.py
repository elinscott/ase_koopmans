...
def _labelize(raw_label):
    # Labels are case_koopmans insensitive and -_. should be ignored, lower and strip it
...
def read_fdf(fname):
    ...
    All labels are converted to lower case_koopmans characters and
...
def read_struct_out(fname):
    ...
    from ase_koopmans.atoms import Atoms, Atom
