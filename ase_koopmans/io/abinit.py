...
from ase_koopmans.units import Hartree, Bohr, fs
...
def write_abinit_in(fd, atoms, param=None, species=None):
    import copy
    from ase_koopmans.calculators.calculator import kpts2mp
    from ase_koopmans.calculators.abinit import Abinit
