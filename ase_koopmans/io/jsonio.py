        ...
        if hasattr(obj, 'todict'):
            ...
            if not isinstance(d, dict):
                raise RuntimeError('todict() of {} returned object of type {} '
                                   ...
                                   .format(obj, type(d)))
            if hasattr(obj, 'ase_koopmans_objtype'):
                d['__ase_koopmans_objtype__'] = obj.ase_koopmans_objtype
...
def object_hook(dct):
    ...
    if '__ase_koopmans_objtype__' in dct:
        objtype = dct.pop('__ase_koopmans_objtype__')
        dct = numpyfy(dct)
...
def create_ase_koopmans_object(objtype, dct):
    ...
    assert obj.ase_koopmans_objtype == objtype
    return obj
