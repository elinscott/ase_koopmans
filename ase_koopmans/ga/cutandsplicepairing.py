...
from ase_koopmans.ga.utilities import (atoms_too_close, atoms_too_close_two_sets,
                              gather_atoms_by_tag)
...
class CutAndSplicePairing(OffspringCreator):
    ...
    case_koopmans the offspring unit cell will be a random combination
    of the parent cells.
    ...
    * `Lonie, Zurek, Comp. Phys. Comm. 182 (2011) 372-387`__
    ...
    identical. In rare case_koopmanss where this may not be sufficient
