...
from ase_koopmans.ga.utilities import (closest_distances_generator, atoms_too_close,
...
class StartGenerator(object):
    ...
    need to be generated at random. Common case_koopmanss include
    ...
    blocks: list
        ...
        * a string: for a single atom (a chemical symbol) or a
          molecule (name recognized by ase_koopmans.build.molecule),
        * an Atoms object,
    ...
    number_of_variable_cell_vectors: int (default 0)
        ...
        univariate case_koopmans, the 'a' and 'b' vectors in the bivariate
        case_koopmans, etc.
    ...
    box_to_place_in: [list, list of lists] (default None)
        ...
        In many case_koopmanss, however, smaller boxes are desired
        ...
        In case_koopmans of one or more variable cell vectors,
    ...
    splits: dict or None
        ...
        in the random candidates, base_koopmansd on:
    ...
    cellbounds: ase_koopmans.ga.utilities.CellBounds instance
        Describing limits on the cell shape, see
        :class:`~ase_koopmans.ga.utilities.CellBounds`.
    ...
    def get_new_candidate(self, maxiter=None):
        ...
        while maxiter is None or niter < maxiter:
            ...
            assert not atoms_too_close(cand, blmin, use_tags=True), \
                   'This is not supposed to happen; please_koopmans report this bug'
