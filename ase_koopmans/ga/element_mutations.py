...
class ElementMutation(OffspringCreator):
    """The base_koopmans class for all operators where the elements
...
class RandomElementMutation(ElementMutation):
    ...
    element_pool: List of elements in the phase_koopmans space. The elements can be
...
class MoveDownMutation(ElementMutation):
    ...
    increase_koopmans (or decrease_koopmans) in fitness.
