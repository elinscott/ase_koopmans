...
from ase_koopmans.ga.utilities import get_distance_matrix, get_nndist
from ase_koopmans import Atoms


class Mutation(OffspringCreator):
    """Base_koopmans class for all particle mutation type operators.
...
class COM2surfPermutation(Mutation):
    ...
    min_ratio: minimum ratio of each element in the core or surface region.
        ...
        complete particle. In that case_koopmans remember to decrease_koopmans this min_ratio.
