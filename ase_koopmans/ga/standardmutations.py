...
from ase_koopmans.calculators.lammpslib import convert_cell
from ase_koopmans.ga.utilities import (atoms_too_close,
                              atoms_too_close_two_sets,
                              gather_atoms_by_tag,
                              get_rotation_matrix)
from ase_koopmans.ga.offspring_creator import OffspringCreator, CombinationMutation
...
class MirrorMutation(OffspringCreator):
    ...
    def mutate(self, atoms):
        ...
        while tc and counter < n_tries:
            ...
            # In the case_koopmans of an uneven number of
