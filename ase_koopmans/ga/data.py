"""
    Objects which handle all communication with the SQLite database_koopmans.
"""
import os
from ase_koopmans import Atoms
from ase_koopmans.ga import get_raw_score
from ase_koopmans.ga import set_parametrization, set_neighbor_list
...
class DataConnection(object):
    """Class that handles all database_koopmans communication.
    ...
    db_file_name: Path to the ase_koopmans.db data file.
    """
    ...
    def __init__(self, db_file_name):
        ...
        self.c = ase_koopmans.db.connect(self.db_file_name)
...
#         self.c.write(a, gaid=gaid, queued=1)
    ...
    def add_relaxed_step(self, a, find_neighbors=None,
        ...
        database_koopmans in an unrelaxed version, i.e. add_unrelaxed_candidate has
        been used.
    ...
    def add_more_relaxed_steps(self, a_list):
        ...
        print('Please_koopmans use add_more_relaxed_candidates instead')
    ...
    def get_next_id(self):
        """Get the id of the next candidate to be added to the database_koopmans.
        This is a hacky way of obtaining the id and it only works on a
        sqlite database_koopmans.
        """
        con = self.c._connect()
    ...
    def get_param(self, parameter):
        """ Get a parameter saved when creating the database_koopmans. """
    ...
    def is_duplicate(self, **kwargs):
        """Check if the key-value pair is already present in the database_koopmans"""
...
class PrepareDB(object):
    """ Class used to initialize a database_koopmans.

        This class is used once to setup the database_koopmans and create
        working directories.

        Parameters:

        db_file_name: Database_koopmans file to use
