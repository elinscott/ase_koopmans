...
from ase_koopmans.utils import pickleload
...
class BEEFEnsemble:
    ...
    def get_beefvdw_ensemble_coefs(self, size=2000, seed=0):
        ...
        from ase_koopmans.dft.pars_beefvdw import uiOmega as omega
    ...
    def get_mbeef_ensemble_coefs(self, size=2000, seed=0):
        ...
        from ase_koopmans.dft.pars_mbeef import uiOmega as omega
    ...
    def get_mbeefvdw_ensemble_coefs(self, size=2000, seed=0):
        ...
        from ase_koopmans.dft.pars_mbeefvdw import uiOmega as omega
...
def BEEF_Ensemble(*args, **kwargs):
    import warnings
    warnings.warn('Please_koopmans use BEEFEnsemble instead of BEEF_Ensemble.')
