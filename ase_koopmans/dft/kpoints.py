...
class BandPath:
    ...
    indirectly using the :class:`~ase_koopmans.geometry.Cell` or
    :class:`~ase_koopmans.lattice.BravaisLattice` classes:

    >>> from ase_koopmans.lattice import CUB
    >>> path = CUB(3).bandpath()
    >>> path
    ...
    @property
    def cell(self) -> Cell:
        """The :class:`~ase_koopmans.cell.Cell` of this BandPath."""
        return self._cell

    @property
    def icell(self) -> Cell:
        """Reciprocal cell of this BandPath as a :class:`~ase_koopmans.cell.Cell`."""
        return self._icell
    ...
    def __iter__(self):
        ...
        """
        import warnings
        warnings.warn('Please_koopmans do not use (kpts, x, X) = bandpath(...).  '
    ...
    def get_linear_kpoint_axis(self, eps=1e-5):
        ...
        See :func:`ase_koopmans.dft.kpoints.labels_from_kpts`."""
    ...
    def plot(self, **plotkwargs):
        ...
        import ase_koopmans.dft.bz as bz
    ...
    def free_electron_band_structure(
            self, **kwargs
    ) -> 'ase_koopmans.spectrum.band_structure.BandStructure':
        """Return band structure of free electrons for this bandpath.

        Keyword arguments are passed to
        :class:`~ase_koopmans.calculators.test.FreeElectrons`.
...
def bandpath(path, cell, npoints=None, density=None, special_points=None,
    ...
    Return a :class:`~ase_koopmans.dft.kpoints.BandPath` object."""
...
def get_special_points(cell, lattice=None, eps=2e-4):
    ...
    if isinstance(cell, str):
        warnings.warn('Please_koopmans call this function with cell as the first '
                      'argument')
