...
from ase_koopmans.io import read, write, string2index
...
class Images:
    ...
    def read(self, filenames, default_index=':', filetype=None):
        ...
        for filename in filenames:
            from ase_koopmans.io.formats import parse_filename
    ...
    def repeat_results(self, atoms, repeat=None, oldprod=None):
        ...
        def getresult(name, get_quantity):
            # ase_koopmans/io/trajectory.py line 170 does this by using
    ...
    def repeat_images(self, repeat):
        ...
        if constraints_removed:
            from ase_koopmans.gui.ui import tk, showwarning
