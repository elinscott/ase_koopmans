...
from ase_koopmans.io.pov import write_pov, get_bondpairs
...
class Render:
    texture_list = ['ase_koopmans2', 'ase_koopmans3', 'glass', 'simple', 'pale',
    ...
    def __init__(self, gui):
        ...
        self.base_koopmansname_widget = ui.Entry(width=30, value=formula,
                                        callback=self.update_outputname)
        win.add([ui.Label(_('Output base_koopmansname: ')), self.base_koopmansname_widget])
    ...
    def update_outputname(self):
        tokens = [self.base_koopmansname_widget.value]
        ...
        #name = self.base_koopmansname.get_text() + movie_index + '.pov'
