...
'''
from ase_koopmans.gui.i18n import _, ngettext

import ase_koopmans.gui.ui as ui
import ase_koopmans.build as build
from ase_koopmans.data import reference_states
...
case_koopmanss the non-orthogonal unit cell will contain fewer atoms.
...
py_template = """
from ase_koopmans.build import {func}
...
class SetupSurfaceSlab:
    ...
    def __init__(self, gui):
        ...
        self.retrieve = ui.Button(_('Get from database_koopmans'),
                                  self.structure_changed)
    ...
    def make(self, *args):
        ...
        ortho_warn_even = _('Please_koopmans enter an even value for orthogonal cell')
        ...
        if struct == _('FCC(211)') and (not (x % 3 == 0) and ortho):
            self.x_warn.text = _('Please_koopmans enter a value divisible by 3'
                                 ' for orthogonal cell')
            return
