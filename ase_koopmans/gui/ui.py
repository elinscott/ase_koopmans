...
class Base_koopmansWindow(object):
...
class Window(Base_koopmansWindow):
    def __init__(self, title, close=None):
        self.win = tk.Toplevel()
        Base_koopmansWindow.__init__(self, title, close)
...
class MainWindow(Base_koopmansWindow):
    ...
    def run(self):
        ...
        # https://gitlab.com/ase_koopmans/ase_koopmans/issues/412
        #
