...
from ase_koopmans.data import reference_states, atomic_numbers
...
def add_adsorbate(slab, adsorbate, height, position=(0, 0), offset=None,
    ...
    produced by one of the utility functions in ase_koopmans.build, it
    ...
    position: The x-y position of the adsorbate, either as a tuple of
        ...
        of the functions in ase_koopmans.build).
