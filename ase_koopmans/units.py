...
to and from ase_koopmans internal units.
...
# module
CODATA = {
    # the "original" CODATA version ase_koopmans used ever since
...
def create_units(codata_version):
    ...
    coded in ase_koopmans.units depending on a certain CODATA version. Note that
    ...
    units: dict
        ...
        ase_koopmans.units as key-value pairs. The dict supports attribute access.
