...
def wulff_construction(symbol, surfaces, energies, size, structure,
    ...
    extracted from ase_koopmans.data.
    ...
    if isinstance(structure, str):
        if structure == 'fcc':
            from ase_koopmans.cluster.cubic import FaceCenteredCubic as structure
        elif structure == 'bcc':
            from ase_koopmans.cluster.cubic import BodyCenteredCubic as structure
        elif structure == 'sc':
            from ase_koopmans.cluster.cubic import SimpleCubic as structure
        elif structure == 'hcp':
            from ase_koopmans.cluster.hexagonal import \
                HexagonalClosedPacked as structure
        elif structure == 'graphite':
            from ase_koopmans.cluster.hexagonal import Graphite as structure
        else:
    ...
    # very difficult in the general case_koopmans!
