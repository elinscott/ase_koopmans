...
class Berny(Optimizer):
    def __init__(self, atoms, restart=None, logfile='-', trajectory=None,
        ...
        Pyberny_. It is base_koopmansd on a redundant set of internal coordinates, and as
        ...
        `here <https://gitlab.com/ase_koopmans/ase_koopmans/-/merge_requests/889>`__.
        ...
        self._berny = _Berny(
            ...
            maxsteps=10000000000,  # TODO copied from ase_koopmans.optimize.Optimizer
            gradientmax=0.,
            gradientrms=0.,
            stepmax=0.,
            steprms=0.,
