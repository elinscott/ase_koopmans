...
from ase_koopmans.optimize.defaults import defaults
...
class FIRE(Optimizer):
    def __init__(self, atoms, restart=None, logfile='-', trajectory=None,
        ...
        if maxstep is not None:
            ...
            warnings.warn('maxmove is deprecated; please_koopmans use maxstep',
        ...
        if self.v is None:
            ...
            if self.downhill_check:
                e = atoms.get_potential_energy(
                    force_consistent=self.force_consistent)
                # Check if the energy actually decrease_koopmansd
                if e > self.e_last:
