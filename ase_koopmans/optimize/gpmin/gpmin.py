...
from ase_koopmans.optimize.gpmin.gp import GaussianProcess
from ase_koopmans.optimize.gpmin.kernel import SquaredExponential
from ase_koopmans.optimize.gpmin.prior import ConstantPrior
...
class GPMin(Optimizer, GaussianProcess):
    def __init__(self, atoms, restart=None, logfile='-', trajectory=None,
        ...
        prior: Prior object or None
            ...
            See ase_koopmans.optimize.gpmin.prior
        ...
        kernel: Kernel object or None
            ...
            See ase_koopmans.optimize.gpmin.kernel
        ...
        if len(atoms) > 100:
            warning = ('Possible Memory Issue. There are more than '
                       ...
                       'of the process will increase_koopmans with the number '
