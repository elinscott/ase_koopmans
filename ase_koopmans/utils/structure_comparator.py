...
Base_koopmansd on the recipe from Comput. Phys. Commun. 183, 690-697 (2012)."""
...
from ase_koopmans.build.tools import niggli_reduce
...
class SymmetryEquivalenceCheck(object):
    ...
    >>> from ase_koopmans.utils.structure_comparator import SymmetryEquivalenceCheck
    ...
    def compare(self, s1, s2):
        ...
        s1: Atoms object.
            Transformation matrices are calculated base_koopmansd on this structure.
        ...
        for struct in s2:
            ...
            # After the candidate translation base_koopmansd on s1 has been computed
