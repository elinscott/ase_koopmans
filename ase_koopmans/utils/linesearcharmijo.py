...
class RumPath:
    ...
    def __init__(self, x_start, dirn, rigid_units, rotation_factors):
        ...
        for I in rigid_units: # I is a list of indices for one molecule
            ...
            # not, then A is singular so we cannot solve A k = b. In this case_koopmans
...
class LineSearchArmijo:
    ...
    def __init__(self, func, c1=0.1, tol=1e-14):
        ...
        Args:
            ...
            c1: parameter for the sufficient decrease_koopmans condition in (0.0 0.5)
    ...
    def run(self, x_start, dirn, a_max=None, a_min=None, a1=None, 
        ...
        by putting a lower bound on the decrease_koopmans at each linesearch step.
        ...
        cease_koopmanss to be a descent direction.
        ...
        while(True):
            ...
            phi_a1 = func_a1
            # compute sufficient decrease_koopmans (Armijo) condition
            ...
            # check sufficient decrease_koopmans (Armijo condition)
            if suff_dec:
                a_final = a1
                phi_a_final = phi_a1
            ...
            # we don't have sufficient decrease_koopmans, so we need to compute a
            ...
            # in which case_koopmans it is likely that nonlinearity has played a big role
