...
class ThermoChem:
    """Base_koopmans class containing common methods used in thermochemistry
    calculations."""
...
class HarmonicThermo(ThermoChem):
    ...
    vib_energies : list
        ...
        ase_koopmans.vibrations.Vibrations.get_energies). The number of
...
class HinderedThermo(ThermoChem):
    ...
    vib_energies : list
        ...
        ase_koopmans.vibrations.Vibrations.get_energies). The number of energies
...
class IdealGasThermo(ThermoChem):
    ...
    base_koopmansd on statistical mechanical treatments in the ideal gas
    approximation.
    ...
    vib_energies : list
        ...
        ase_koopmans.vibrations.Vibrations.get_energies). The number of vibrations
