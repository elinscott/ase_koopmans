...
class Cell:
    ...
    ase_koopmans_objtype = 'cell'  # For JSON'ing
    ...
    def cellpar(self, radians=False):
        ...
        See also :func:`ase_koopmans.geometry.cell.cell_to_cellpar`."""
    ...
    @classmethod
    def ascell(cls, cell):
        """Return argument as a Cell object.  See :meth:`ase_koopmans.cell.Cell.new`.
    ...
    def fromcellpar(cls, cellpar, ab_normal=(0, 0, 1), a_direction=None):
        ...
        See also :func:`~ase_koopmans.geometry.cell.cellpar_to_cell()`."""
        from ase_koopmans.geometry.cell import cellpar_to_cell
        cell = cellpar_to_cell(cellpar, ab_normal, a_direction)
        return cls(cell)

    def get_bravais_lattice(self, eps=2e-4, *, pbc=True):
        """Return :class:`~ase_koopmans.lattice.BravaisLattice` for this cell:
        ...
        .. note:: The Bravais lattice object follows the AFlow
           ...
           :meth:`ase_koopmans.cell.Cell.bandpath` instead of this method.
           This maps the kpoints back to the original input cell.

        """
        from ase_koopmans.lattice import identify_lattice
    ...
    ) -> "ase_koopmans.dft.kpoints.BandPath":
        """Build a :class:`~ase_koopmans.dft.kpoints.BandPath` for this cell.
    ...
    def complete(self):
        ...
        from ase_koopmans.geometry.cell import complete_cell
    ...
    def orthorhombic(self):
        ...
        from ase_koopmans.geometry.cell import is_orthorhombic
    ...
    def scaled_positions(self, positions):
        ...
        :meth:`~ase_koopmans.cell.Cell.complete`."""
    ...
    def niggli_reduce(self, eps=1e-5):
        ...
        See also :func:`ase_koopmans.build.tools.niggli_reduce_cell`."""
        from ase_koopmans.build.tools import niggli_reduce_cell
    ...
    def minkowski_reduce(self):
        ...
        See also :func:`ase_koopmans.geometry.minkowski_reduction.minkowski_reduce`."""
