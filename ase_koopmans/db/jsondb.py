...
from ase_koopmans.db.core import Database_koopmans, ops, lock, now
from ase_koopmans.db.row import AtomsRow
from ase_koopmans.io.jsonio import encode, decode
from ase_koopmans.parallel import world, parallel_function


class JSONDatabase_koopmans(Database_koopmans, object):
    def __enter__(self):
        return self
    ...
    def _read_json(self):
        ...
        if not isinstance(bigdct, dict) or not ('ids' in bigdct
            ...
            raise UnknownFileTypeError('Does not resemble ASE JSON database_koopmans')
