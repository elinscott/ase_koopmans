...
class AtomsRow:
    ...
    def constraints(self):
        ...
        if not isinstance(self._constraints, list):
            ...
            for c in cs:
                ...
                if c['name'].startswith('ase_koopmans'):
    ...
    def data(self):
        ...
        if isinstance(self._data, str):
            ...
            from ase_koopmans.db.core import bytes_to_object
...
def row2dct(row,
    ...
    from ase_koopmans.db.core import float_to_time_string, now
