...
extras.append(( add_isosurface_to_pov, dict( density_grid = vchg.chg[0], cut_off = density_cut_off)))


#### spin up density, how to specify color and transparancy r,g,b,t and a material style from the standard ASE set
extras.append(( add_isosurface_to_pov, dict( density_grid = vchg.chgdiff[0], cut_off = spin_cut_off,
